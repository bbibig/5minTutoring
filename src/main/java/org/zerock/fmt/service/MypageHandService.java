...
public interface MypageHandService {
	...
	public abstract List<UseHandQVO> getAllMyUsehandtQList(CriteriaMyPage cri) throws ServiceException;
	...
	public abstract List<UseHandTVO> getAllMyUsehandtTList(CriteriaMyPage cri) throws ServiceException;
