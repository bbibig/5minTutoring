        ...
        <section id="hero" class="hero align-items-center">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <h1 class="display-4 text-center">kakao - Student Sign up</h1>
                    </div>
                        ...
                        <div class="login_form">
                            ...
                            <form action="#" method="post" class="needs-validation" name="kakaoRegisterForm" id ="kakaoRegisterForm" novalidate>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" value="${email}" class="form-control" name="user_email" id="user_email" >
                                </div>

                                <div class="form-group">
                                    <label for="password">비밀번호</label>
                                    <input type="hidden" value="${password}" class="form-control" name="user_pw" id="user_pw">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="nick">
                                        <input type="text" class="form-control" name="user_nick" id="user_nick" placeholder="한글 영문 숫자 2~10자" 
                                            style="width:73%;float:left" value="${nickname}">
