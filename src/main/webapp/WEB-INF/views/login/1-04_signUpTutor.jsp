                    ...
                    <div class="login_form">
                        <form action="#" method="" enctype="text/plain" class="needs-validation" novalidate>
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control mt-1" id="password" data-kv="password"
                            ...
                            <div class="form-group">
                                ...
                                <div class="nick">
                                    <input type="text" class="form-control" id="nickName" placeholder="영문 한글 숫자 2~10자"
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <input type="text" class="form-control" id="phone" style="width:75%;float:left">
                                    <button type="button" class="btn btn-outline-primary mt-2" style="float: right">
                                        인증하기</button>
                                    <div style="clear: both"></div>
                                </div>
                            ...
                            <div class="form-group mt-2">
                                <form action="#" method="post" enctype="multipart/form-data">
                                    ...
                                    <input class="form-control" type="file" id="tutor_signFile">
