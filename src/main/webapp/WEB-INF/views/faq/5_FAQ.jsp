		...
		<div class="container">
			...
			<nav aria-label="Page navigation example">
				<ul class="pagination justify-content-center p-5">
					<li class="page-item" id="bPrev1"><a class="page-link rounded-circle" href="/faq?currPage=1">&laquo;</a></li>
					<li class="page-item" id="bPrev2"><a class="page-link rounded-circle" href="/faq?currPage=${_FAQPAGENATION_.cri.currPage - 1}">&lt;</a></li>
					...
					<li class="page-item" id="bNext1"><a class="page-link rounded-circle" href="/faq?currPage=${_FAQPAGENATION_.cri.currPage + 1}">&gt;</a></li>
					<li class="page-item" id="bNext2"><a class="page-link rounded-circle" href="/faq?currPage=${_FAQPAGENATION_.realEndPage}">&raquo;</a>
					</li>
				</ul>
			</nav>
