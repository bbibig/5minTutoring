...
=======
			<script>
				...
				//댓글조회
				// var commentservice = (function get(cno, callback, error) {
        // 	console.log("조회 댓글번호: " + cno);
    		...
    		// })(); // get
				...
				// $('#comment_list').on("click", '.commentUpdateBtn', function(e) {
				
				// var cm_number = $(".commentUpdateBtn").data("cm_no");
			...
			$('#comment_list').on("click",".commentUpdateBtn", function(){
				var cm_content = $(this).data("cm_content");
				
				$("input[name=cm_content]").val(cm_content);

				var fb_no = $(this).data("fb_no");
				var cm_no = $(this).data("cm_no");

				$("#modal_fb_no").val(fb_no);
				$("#modal_cm_no").val(cm_no);
	                                ...
	                                <div class="modal-body">
	                                    <div class="pop-up-body d-flex flex-column align-items-center">
	                                        ...
	                                        <form class="was-validated col-12 d-flex flex-column">
																						<input type="hidden" id="modal_fb_no" name="fb_number">
																						<input type="hidden" id="modal_cm_no" name="cm_number">
	                                            <div class="text-box">
	                                                <textarea class="form-control" name="cm_content" value="" style="height: 150px" required></textarea>
	                                            </div>
	
	                                            <div class="pop-up-button-box align-self-end">
	                                                <button type="button" class="btn btn-outline-primary"
	                                                    data-bs-dismiss="modal">취소</button>&nbsp;&nbsp;&nbsp;
	                                                <button type="submit" class="btn btn-outline-primary" id="updateBtnModal">확인</button>
	                                            </div>
	                                        </form>
	                                    </div>
	                                </div>
	                                ...
	                                <div class="dropdown">
	                                    ...
	                                    <ul class="dropdown-menu">
	                                        <li class="list-unstyled">
																						<a class="commentUpdateBtn dropdown-item " data-bs-toggle="modal" 
																						data-fb_no="${commentList.fb_number}" data-cm_content="${commentList.cm_content}"  data-cm_no="${commentList.cm_number}"
																						id="updateCommentBtn" data-bs-target="#commentModal">수정</a>
	                                        </li>
	                                        <li class="list-unstyled"><a class="dropdown-item" data-bs-toggle="modal" 
	                                                href="#delete">삭제</a>
	                                        </li>
